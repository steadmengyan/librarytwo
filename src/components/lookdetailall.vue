<template>
	<div id="lookdetail">
		...
		<div class="content content-all" v-show="!xianshi" style="height:100%">
			<div class="title">《{{arr.title}}》</div>
	...
	export default {
		data() {
			...
			mounted() {
				...
				console.log(this.Id+'wwwwwwwwwwwwww');
				var than = this;
				this.$axios({
...
<style scoped>
	...
	.content {
		...
		.content-all{height: auto!important;margin-bottom: 3rem;}
		.content-all .cont{height: auto!important;}
		.content-all .down i{top:-10rem}
	...
	/*@media screen and (min-width: 601px) and (max-width: 768px) {
		...
		.content-all{height: auto!important;}
		.content-all .cont{height: auto!important;}
		.content-all .down i{top:-10rem}
	}*/
</style>